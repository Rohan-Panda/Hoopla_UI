...
class RS extends Component {
  ...
  submitRegister = (e) => {
    ...
    {
        sCredentials: {
            sEmail: this.state.form.email,
            sPass: this.state.form.password,
        },
        sName: this.state.form.username,
        sPhone: this.state.form.mobNumber,
        sGst: this.state.form.gstNumber,
        sTan:this.state.form.tanNumber,
        sAccountNo: this.state.form.accountNumber
    };
    ...
    axios.post(usersBackendURL + 'regSeller', userRegisterData)
        ...
        <div className="col-md-4 offset-4">
          <main className={classes.main}>
            ...
            <Paper className={classes.paper}>
              ...
              <form className={classes.form} onSubmit={this.submitRegister} id="SellerRegform">
              
                <FormControl margin="normal" required fullWidth>
                  <InputLabel htmlFor="sEmail">Email Id</InputLabel>
                  <Input autoComplete="uName" autoFocus
                    name="sEmail" type="email" id="sEmail"
                ...
                <FormControl margin="normal" required fullWidth>
                  ...
                  <Input name="sPass" type="password" value={password}
                ...
                <FormControl margin="normal" required fullWidth>
                  <InputLabel htmlFor="sTan">TAN number</InputLabel>
                  <Input name="sTan"  id="sTan"
                    value={tanNumber} onChange={this.handleInputChange} />
                  <span className="text-danger">{formErrMsg.tanNumber}</span>
                </FormControl>
                 
                <FormControl margin="normal" required fullWidth>
                  <InputLabel htmlFor="sGST">GST number</InputLabel>
                ...
                <FormControl margin="normal" required fullWidth>
                  <InputLabel htmlFor="sAccount">Account number</InputLabel>
                  <Input name="sAccount" type="number" id="sAccount"
                ...
                <FormControl margin="normal" required fullWidth>
                  ...
                  <Input name="sPhone" type="number" id="sPhone"
